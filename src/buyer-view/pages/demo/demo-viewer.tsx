...
const DemoViewer= (props: {data: any}) => {
    ...
    return (
        <div className="j-buyer-demo">
            {
                data.buyerUsecase.video ?
                    <Space direction="vertical" className="cm-width100 j-demo-view-wrapper">
                        ...
                        <div className="cm-flex-center j-buyer-demo-player cm-width100 cm-aspect-ratio16-9">
                            {getDemoVideoPlayer(data.buyerUsecase["video"])}
                        </div>
                    </Space>
                :
                    null
            }
            {
                data.buyerUsecase["walkthrough"] ? 
                    <Space direction="vertical" className="cm-width100 j-demo-view-wrapper">
                        ...
                        {getTourViewer(data.buyerUsecase["walkthrough"])}
                    </Space>
                : 
                    null
            }
