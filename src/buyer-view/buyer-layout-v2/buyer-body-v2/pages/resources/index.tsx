...
import { RESOURCE_COUNT, Length_Input } from "../../../../../constants/module-constants";
        ...
        <>
            <div className="bn-section-body-wrapper" style={{minHeight: "calc(100vh - 410px)"}}>
                ...
                {/* <div className="cm-width100 cm-height100 cm-row j-buyer-cm-padding-float cm-overflow-hidden"> */}
                    <div className="cm-height100 cm-width100 j-res-list-col j-buyer-cm-card cm-padding0 cm-overflow-hidden" style={{ borderRadius: "8px" }}>
                        ...
                        </div>
                        {
                            loading 
                            ? 
                                <div style={{minHeight: "calc(100vh - 410px)"}} className='cm-flex-center'>
                                    <Loading /> 
                                </div>
                            : 
...
export default BuyerResourcesV2