            ...
            <div className="cm-modal-footer">
                <Space className='cm-width100 cm-margin-top15 cm-flex-justify-end'>
                    ...
                    {selectedContacts.length < contacts.length && selectableContacts.length > 0 && 
                        <Button style={{width: "150px"}} type="primary" onClick={handleAddAndContinue} className={!(selectedContacts.length > 0) ? "cm-button-disabled cm-cursor-disabled" : ""}>
                            <Space size={10}>
                                {submitState.text}
                                {
