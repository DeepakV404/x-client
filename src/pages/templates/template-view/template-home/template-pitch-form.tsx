...
import { PASTE_LINK, SELECT_FROM_LIBRARY, UPLOAD_FROM_DEVICE } from './template-edit-home-form';
...
const TemplatePitchForm = (props: {pitchRef: any, pitchVideo: any}) => {
                ...
                case PASTE_LINK:
                    return (
                        <Space direction='vertical' className='cm-width100'>
                            <Space className='cm-width100' direction='vertical'>
...
export default TemplatePitchForm