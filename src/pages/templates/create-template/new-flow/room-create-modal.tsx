...
import UseTemplates from "./use-template-modal";
import { prebuildTemplates } from "../../../rooms/create-room/new-flow/prebuil-templates";
import { BASIC, BLANK, ONE_PAGER } from "../../../../constants/module-constants";

const Templates = (props: {onClose: () => void,}) => {
    ...
    const [isTemplateSelected, setIsTemplateSelected]   =   useState<{isOpen: boolean, id?: string, preBuildTemplate?: boolean, templateType?: string}>({
        isOpen: false,
        id: "",
    })
    ...
    return (
        <>
                            ...
                            ? 
                                <>
                                    <div className="cm-flex-space-between-center cm-margin-bottom20">
                                        ...
                                        <Button type="primary" iconPosition="end" icon={<MaterialSymbolsRounded font="arrow_forward" size="22"/>} onClick={() => setIsTemplateSelected({isOpen: true, id: isPreview.templateData.uuid, preBuildTemplate: true})}>Use template</Button>
                                    </div>
                                            ...
                                            {prebuildTemplates.map((template: any) => (
                                                <div key={template.uuid} className="j-create-room-modal-main-card cm-position-relative hover-item">
                                                    ...
                                                    <div className="cm-position-absolute show-on-hover" style={{width: "90%", paddingTop: "10px"}}>
                                                        ...
                                                        <Button style={{width: "125px"}} type="primary" onClick={() => setIsTemplateSelected({isOpen: true, id: template.uuid, preBuildTemplate: true})}>Use template</Button>
                                                    </div>
                                                    <Space size={2} direction="vertical">
            ...
            <UseTemplates 
                isOpen={isTemplateSelected.isOpen}
                onClose={() => setIsTemplateSelected({isOpen: false, id: "", preBuildTemplate: false})}
