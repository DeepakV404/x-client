...
import EditEmbedComponent from "./edit-embed-component";
import WidgetTitle from "../../widget-title";

const EditEmbedWidget = (props: { editWidgetProps: any, onClose: any, sectionId: string, widget: any, module: any }) => {
                ...
                <Space direction="vertical" className="cm-width100 cm-padding-bottom20">
                    ...
                    </Collapse>
                    {
                        widget.components.map((_component: any) => (
                            <EditEmbedComponent component={_component} widget={__widget} module={module}/>
                        ))
                    }
                </Space>
            </div>
