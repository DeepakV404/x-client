...
const EditFileUploadWidget = (props: { editWidgetProps: any, onClose: any, sectionId: string, widget: any, module: any }) => {
    ...
    return (
        ...
        <div className='j-edit-widget-text-drawer-body cm-padding15'>
            <Space direction="vertical" className="cm-width100 cm-padding-bottom20">
                <Collapse
                    defaultActiveKey={[__widget.uuid]}
...
export default EditFileUploadWidget